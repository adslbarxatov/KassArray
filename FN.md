...
2. Формирование выгрузок архивов ФН в формате `.fnc` в соответствии с [Приложением](https://nalog.gov.ru/rn77/about_fts/docs/10020801) 2 к приказу
...
Чтение может быть выполнено четярьмя способами:
...
- Основных и распозаваемых приложением текстовых данных, а также подтверждений от ОФД и фискальных признаков сообщений;
- Всех доступных тегов, в том числе – неизвестных модулю (последние отображаются в шестнадцатеричном виде).
