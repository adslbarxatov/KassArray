...
- [Модуль чтения и обработки данных ФН для KassArray](#kassarray-1)
    1. [Общие сведения](#section)
    2. Начало работы
    2.1. [Подключение ФН и адаптера к ПК](#section-2)
    2.2. [Установка драйвера устройства](#section-3)
    3. [Работа с модулем](#section-5)
    3.1. [Функции, доступные при запуске](#section-6)
    3.2. [Функции, доступные после открытия порта, загрузки файла и в режиме прямого чтения](#section-19)
...
Более подробно функционал продукта для Windows и Android представлен в [данной видеоинструкции](https://youtube.com/watch?v=fdH4SKFdTCI).
...
9. :new: ***Кэширование имеющихся файлов*** `.fnc` и быстрый доступ к любому из них с помощью поиска по ИНН, заводским номерам,
...
![44](https://user-images.githubusercontent.com/20893717/222724102-b1efe42f-53bb-4717-b5a2-4a9999dd6690.png)
