...
- дополнительно: получать разложения и представления чисел в системах счисления с основаниями 2, 10 и 16, а также коды Unicode по символам и наоборот.
...
операциям Вы можете найти в [этом разделе](https://adslbarxatov.github.io/KassArray/quick).
