...
- Модуль чтения и обработки данных ФН для KassArray
    ...
    - [Ассоциировать форматы файлов](#section-16)
    ...
    - [Прямое чтение из ФН](#section-22)
...
со всеми ОФД, действующими на *1 октября 2023 года*. Тем не менее, выбор ***ручного обмена*** позволяет указать любой неаннулированный ОФД вручную.
